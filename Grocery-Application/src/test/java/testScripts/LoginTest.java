...
public class LoginTest extends BaseClass {
  ...
  @Test(groups="smoke")
	public void loginWithValidCredentials() throws IOException {
	 ...
	 /* login.enterUsername("admin");
	  ...
	  //Assert.assertTrue(isHomePageLoaded, "Login failed with valid credentials");
  ...
  public void loginWithInvalidUserNameAndPassword(String username,String password) {
	 ...
	 // login.clickSignInButton();
	  ...
	  Assert.assertTrue(alertMessageForInvalidUserNameAndPassword,"Login successful for invalild username and password");
  }
}
